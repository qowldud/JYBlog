  ...
  return (
    <div className={styles.container}>
      ...
      >
        ...
        <div className={styles.container__list__content}>
          <strong>유니온</strong>은 대학을 의미하는 University에서 Uni를 따오고,
          online에서 on을 따와 합쳐서 만들었습니다. <br /> 대학생들이 온라인에서
          모인다는 의미가 있으며 그 단어 자체로도 결합이라는 의미가 있어
          대학생들 간의 결합을 뜻하기도 합니다.
          <br /> 이 앱은 대학 인증을 완료한 대학생들끼리 소통할 수 있는
          커뮤니티이며, 보다 신뢰도 높은 환경에서 자유롭게 소통할 수 있습니다.
          <br />
          또한, 모임 기능을 추가하여 지역 기반 소모임을 만들고 참여할 수 있도록
          했으며, 이를 통해 학생들이 온라인에서 정보를 나누는 것에 그치지 않고,
          <br />
          오프라인 모임으로 자연스럽게 이어질 수 있도록 하고 있습니다. <br />
          이처럼 UNION은 대학생들이 오프라인과 온라인을 유기적으로 연결하여,
          교류할 수 있는 실질적인 커뮤니티 환경을 제공하는 것을 목표로 하고
          있습니다.
        </div>
      </div>
